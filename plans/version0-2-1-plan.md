...
8. ✅ **Git tag** `v0.2.1` создан и запушен (2026-02-09)
9. ✅ **GitHub Release** v0.2.1 создан: https://github.com/BigKAA/topologymetrics/releases/tag/v0.2.1
10. ✅ **PyPI**: dephealth 0.2.1 опубликован: https://pypi.org/project/dephealth/0.2.1/
11. ✅ **Maven Central**: dephealth-core 0.2.1 и dephealth-spring-boot-starter 0.2.1 опубликованы
12. **NuGet** — не опубликован (нет make publish target в sdk-csharp — TODO)
