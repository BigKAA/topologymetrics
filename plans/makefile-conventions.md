...
| --- | --- | --- |
| Go | `golang:$(GO_VERSION)` | `golangci/golangci-lint:$(LINT_VERSION)` |
| Python | `python:$(PYTHON_VERSION)-slim` | Встроенный (`ruff`, `mypy`) |
| Java | `maven:$(JAVA_VERSION)` | Встроенный (SpotBugs, Checkstyle) |
...
PY_IMAGE     = python:$(PYTHON_VERSION)-slim
PROJECT_ROOT = $(shell cd .. && pwd)
