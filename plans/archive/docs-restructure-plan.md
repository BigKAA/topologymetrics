...
- [x] 1.7 Создать `sdk-go/README.ru.md` — русская версия README
...
- [x] 6.1 Обновить `README.md` и `README.ru.md` — секция документации с новой структурой
  - Выполнено в Фазе 5; дополнительно: добавлена секция «Code Style» в `README.ru.md`
- [x] 6.2 Обновить `sdk-architecture.md` — если есть ссылки на старую структуру
  - Выполнено в Фазе 5; проверено — ссылок на старую структуру нет
- [x] 6.3 Проверить все ссылки во всех `.md` файлах (dead link check)
  - Проверено 163 файла, 1057 ссылок; найдено и исправлено 6 битых ссылок:
  - `docs/code-style/overview.md` / `.ru.md` — specification ссылка → `../specification.md`
  - `CONTRIBUTING.ru.md` — GIT-WORKFLOW.ru.md и conformance/README.ru.md → EN-версии
  - `sdk-java/docs/README.md` / `.ru.md` — Javadoc путь: `target/site/` → `target/reports/`
- [x] 6.4 Запустить markdownlint на все новые и изменённые файлы
  - 134 файла проверено, 0 ошибок, 0 предупреждений
- [x] 6.5 Обновить `TODO.md`
  - Добавлена секция Documentation с завершёнными пунктами
- [x] 6.6 Создать коммиты (по одному на фазу или логическую группу)
- [x] 6.7 Перенести этот файл в `plans/archive/`
